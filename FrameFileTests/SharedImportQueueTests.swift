...
final class SharedImportQueueTests: XCTestCase {
    ...
    func testPendingImportFromEarlierVersionWithoutTitleStillDecodes() async throws {
        ...
        let importDirectory = directory
            .appendingPathComponent(FrameFileAppGroup.pendingDirectoryName, isDirectory: true)
    ...
    private func temporaryDirectory() -> URL {
        FileManager.default.temporaryDirectory
            .appendingPathComponent("FrameFileQueueTests-\(UUID().uuidString)", isDirectory: true)
    }
}
