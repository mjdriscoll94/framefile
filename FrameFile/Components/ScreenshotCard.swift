...
struct ScreenshotCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: FrameFileTheme.compactSpacing) {
            ...
            Color.clear
                ...
                .clipShape(RoundedRectangle(cornerRadius: FrameFileTheme.imageCornerRadius))
                .overlay {
                    RoundedRectangle(cornerRadius: FrameFileTheme.imageCornerRadius)
            ...
            HStack(spacing: FrameFileTheme.compactSpacing) {
