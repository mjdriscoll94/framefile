...
struct SettingsView: View {
    ...
    @State private var exportDocument = FrameFileExportDocument()
    ...
    var body: some View {
        Form {
            ...
            Section("Your Data") {
                ...
                Text("Export creates a .framefile folder package containing JPEG images, OCR text files, and JSON metadata. It is not a ZIP archive.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
        ...
        .fileExporter(
            ...
            contentType: .frameFileExport,
            defaultFilename: "FrameFile Export.framefile"
        ) { result in
    ...
    private func prepareExport() {
        do {
            ...
            exportDocument = FrameFileExportDocument(payload: payload)
            isExporting = true
        } catch {
            errorMessage = error.localizedDescription
        }
