                        ...
                        ForEach(Self.availableSymbols, id: \.self) { symbol in
                            Button {
                                ...
                                Image(systemName: symbol)
                                    ...
                                    .background(
                                        symbolName == symbol
                                            ? FrameFileTheme.brandBlue.opacity(0.14)
                                            : FrameFileTheme.cardBackground,
                                    ...
                                    .overlay {
                                        RoundedRectangle(cornerRadius: 10)
                                            .stroke(
                                                symbolName == symbol
                                                    ? FrameFileTheme.brandBlue
                                                    : FrameFileTheme.cardStroke,
                                                lineWidth: symbolName == symbol ? 2 : 1
                                            )
                                    }
                            }
                            .buttonStyle(.plain)
                            .foregroundStyle(symbolName == symbol ? FrameFileTheme.brandBlue : Color.primary)
